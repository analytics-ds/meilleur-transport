---
title: "How does the bonus-malus work for motorcycle insurance in France?"
description: "How the French no-claims coefficient is calculated: 5% off per claim-free year, 25% added per at-fault accident, and the two-wheelers the law leaves out entirely."
translationKey: "bonus-malus-assurance-moto"
date: 2026-08-24
lastmod: 2026-08-24
author: "Julien Mercier"
authors: ["Julien Mercier"]
categories: ["Individuals"]
tags: ["motorcycle insurance", "bonus-malus", "no-claims discount", "premium", "two-wheelers"]
image: "/images/meilleur-assureur-moto-reputation/meilleur-assureur-moto-reputation-2.webp"
imageAlt: "How the bonus-malus works for motorcycle insurance in France"
draft: false
faq:
  - question: "How does the bonus-malus work for motorcycle insurance in France?"
    answer: "The bonus-malus, formally the reduction-increase coefficient, starts at 1 when you take out a policy and multiplies the reference premium. Every claim-free year multiplies it by 0.95, a 5% reduction, down to a floor of 0.50 which is the maximum 50% discount. Every at-fault accident multiplies it by 1.25, a 25% increase, halved to 12.5% when responsibility is shared. The result is rounded down to two decimal places. Note that mopeds and light motorcycles are excluded from the statutory system."
  - question: "How long does it take to get back to a coefficient of 1 after an at-fault claim?"
    answer: "Two years. After an at-fault accident, the coefficient returns to 1 provided no new at-fault accident occurs during two consecutive years. This fast-track rule applies both after a 25% increase and after a 12.5% increase for shared responsibility. Once back at 1, the 5% annual reduction resumes as normal."
  - question: "Does the bonus-malus follow the rider or the motorcycle?"
    answer: "The rider. The coefficient attaches to the person rather than the vehicle, so it follows you when you change bikes and when you change insurer. The proof is the relevé d'information, issued by your insurer every year at renewal: it states your coefficient and lists at-fault claims over the five preceding annual periods."
  - question: "Does the bonus-malus apply to a 50cc scooter or a 125?"
    answer: "Not in the legal sense. The French public service explicitly lists mopeds and light motorcycles among the vehicles excluded from the bonus-malus system, alongside motor quadricycles and classic vehicles over thirty years old. An insurer remains free to apply its own discount or surcharge scale on those policies, but that is not the statutory coefficient and the rules vary between companies."
  - question: "Does a non-fault accident increase the malus?"
    answer: "No. Only claims where your liability is engaged count towards the calculation. An accident in which you bear no responsibility triggers no increase at all. Where responsibility is shared between riders, the increase is halved to 12.5% instead of 25%."
  - question: "What happens to the bonus if you stop insuring your motorcycle for several months?"
    answer: "If the gap is under three months and no at-fault claim occurred during the year, you still receive the 5% improvement when you take out your next policy. Beyond three months you keep the coefficient you held before the interruption, but the insurer may choose to treat you as a new rider if the gap has been very long."
---
...
## The calculation in one table {#table}
...
## How the coefficient is calculated, year by year {#calculation}
...
This is the part many riders miss: past the floor, another claim-free year adds nothing to the coefficient. The only remaining lever on the premium is the policy itself, its level of cover and its options, which brings you back to the trade-off between **[third-party and comprehensive cover](/en/blog/third-party-or-comprehensive-motorcycle-insurance/)**.

## What pushes the malus up {#malus}
...
## The two-wheelers the law leaves out {#exclusions}
...
In practice, a 50cc scooter or a 125 does not fall under the regulatory coefficient. That does not mean rider behaviour has no effect on the price: an insurer remains free to apply its own discount and surcharge scale on those policies. But it is no longer the statutory mechanism, the rules differ between companies, and the answer sits in the policy wording rather than in an assumption. The point matters most for a **[young rider on a 125](/en/blog/young-driver-125-insurance/)**, who often discovers the nuance only when switching insurer.

## The coefficient follows the rider, not the machine {#rider}
...
## Carrying a car bonus over to a motorcycle policy {#car-bonus}
...
## What happens if you stop insuring {#interruption}
...
## Where to find your coefficient {#statement}
...
## Which insurer when you have a bonus, or a malus {#insurer}

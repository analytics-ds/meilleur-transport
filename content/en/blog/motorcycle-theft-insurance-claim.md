---
title: "Motorcycle stolen: what to do to get paid out by the insurer"
description: "The two-working-day reporting deadline, the documents that decide the payout, the 30-day waiting rule, how the expert values the bike, and the two levers that reduce the theft deductible."
...
![Motorcycle parked on the street, theft protection](/images/meilleurs-assureurs-deux-roues/meilleurs-assureurs-deux-roues-2.webp "Motorcycle theft and insurance compensation")

## The sequence, in order {#sequence}
...
## Filing the report, and why it cannot wait {#report}
...
## Two working days, the breaking point {#deadline}
...
## The documents that condition payment {#documents}
...
## What theft does not do: raise the bonus-malus {#bonus-malus}
...
## Stolen accessories, a separate regime {#accessories}

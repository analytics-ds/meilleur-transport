---
title: "Comment fonctionne le bonus-malus en assurance moto ?"
description: "Calcul du coefficient, baisse de 5 % par an, majoration de 25 % après un sinistre responsable, et les deux-roues que la loi exclut purement et simplement du système."
...
## Le calcul en un tableau {#tableau}

| Situation | Effet sur le coefficient | Calcul |
|---|---|---|
...
| Un accident non responsable | **aucun** | coefficient inchangé |
| Deux ans sans accident responsable après un malus | **retour à 1** | descente rapide |
| Plancher atteint | **0,50** | ne peut plus baisser |
...
## Comment se calcule le coefficient, année après année {#calcul}
...
C'est le point que beaucoup de motards manquent : passé le plancher, une année sans sinistre n'apporte plus rien sur le coefficient. Le seul levier restant sur la prime devient le contrat lui-même, sa formule et ses options, ce qui renvoie à l'arbitrage entre les **[formules au tiers et tous risques](/blog/assurance-moto-tiers-ou-tous-risques/)**.

## Ce qui fait monter le malus {#malus}
...
## Les deux-roues que la loi exclut du bonus-malus {#exclusions}
...
## Reprendre un bonus auto sur un contrat moto {#bonus-auto}
...
## Ce qui se passe si vous arrêtez d'assurer {#interruption}
...
## Où trouver son coefficient {#releve}
...
## Quel assureur quand on a du bonus, ou du malus {#assureur}

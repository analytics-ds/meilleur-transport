...
export default {
  async fetch(request, env, ctx) {
    ...
    if (isAIBot(ua)) {
      try {
        const serveUrl = 'https://app.meteoria.ai/api/crawler-analytics/bot-content/serve?token=mt_c6179aaf275f44feb1fb1c687ed37340&path=' + encodeURIComponent(requestUrl.pathname);
